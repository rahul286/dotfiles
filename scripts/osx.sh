...
# Flycut App                                                               #
###############################################################################
defaults write com.generalarcade.flycut displayNum  40
defaults write com.generalarcade.flycut loadOnStartup  1
defaults write com.generalarcade.flycut menuIcon  2
defaults write com.generalarcade.flycut pasteMovesToTop  1
defaults write com.generalarcade.flycut removeDuplicates  1
defaults write com.generalarcade.flycut saveForgottenFavorites  0
defaults write com.generalarcade.flycut skipPasswordFields  0
defaults write com.generalarcade.flycut skipPboardTypes  0
defaults write com.generalarcade.flycut wraparoundBezel 1
